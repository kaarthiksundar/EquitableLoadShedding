set terminal cairolatex standalone pdf dashed transparent \
header \
...
# set yrange [0:4.5]
# set ytics 0, 1.0, 4.0
set ylabel 'Load shed'
# set xrange [1.0:11.0]
# set xtics   ('11' 2.0, '24' 4.0, '40' 6.0, '134' 8.0, '276' 10.0)
set xlabel 'load id'
set output output
plot for[i=4:53] 'rts_gmlc_risk_eq_ops.csv' every ::0::0 u i 
# plot 'rts_gmlc_risk_eq_ops.csv' using (2):1 ls 2 notitle, \
